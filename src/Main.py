...
main = tkinter.Tk()
main.title("Fraud Detection in Banking Data by Machine Learning Techniques") #designing main screen
...
font = ('times', 16, 'bold')
title = Label(main, text='Fraud Detection in Banking Data by Machine Learning Techniques')
